...
overflow-y: auto;">
	...
	<div class="row" style="margin-right: 0px;">
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="botonera">
			<a class="btn btn-success" href="app/tutor/alumno/verProfesoresParaCita.do"><i class="fa fa-calendar"></i>&nbsp;&nbsp;Cita</a>
			<a class="btn btn-success" href="app/tutor/profesor/enviarNotificacion.do"><i class="fa fa-send"></i>&nbsp;&nbsp;Notificaci&oacute;n</a>
			<a class="btn btn-success" href="app/tutor/alumno/estadisticas.do?alumnoId=${alumno.id}"><i class="fa fa-bar-chart-o"></i>&nbsp;&nbsp;Estad&iacute;sticas</a>
		</div>
</div>
