...
(function($) {
	...
	var defaults_extended = {
		first_day: 2,
		holidays:  {
			'01-01':    "A&ntilde;o Nuevo",
			'06-01':    "D&iacute;a de Reyes",
			'easter-3': "Jueves Santo",
			'easter-2': "Viernes Santo",
			'easter':   "Pascua",
			'easter+1': "Lunes de Pascua",
			'01-05':    "D&iacute;a del Trabajador",
			'15-08':    "Asunci&oacute;n",
			'12-10':    "Fiesta Nacional de Espa&ntilde;a",
			'01-11':    "Día de todos los Santos",
			'06-12':    "Día de la Constituci&oacute;n",
			'08-12':    "Inmaculada Concepci&oacute;n",
			'25-12':    "Navidad"
		}
	};
	...
	var strings = {
			...
			error_timedevide: 'Calendario: par&aacute;metro para el separador de hora debe dividir 60 por un entero. Por ejemplo 10, 15, 30',
			...
			week:        'Semana {0}',
			all_day:     'Todo el d&iacute;a',
			time:        'Tiempo',
			events:      'Desarrollos',
			before_time: 'Tiempo antes de la cinta final',
			after_time:  'Fin despu&eacute;s de una cinta temporal',
