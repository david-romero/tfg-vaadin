 ...
 * relevant actions.
 */
public class AppEducacionalEventBus implements SubscriberExceptionHandler{

	private final EventBus eventBus = new EventBus(this);

    public static void post(final Object event) {
        AppUI.getAppEducacionalEventbus().eventBus.post(event);
    }

    public static void register(final Object object) {
    	AppUI.getAppEducacionalEventbus().eventBus.register(object);
    }

    public static void unregister(final Object object) {
    	AppUI.getAppEducacionalEventbus().eventBus.unregister(object);
    }
