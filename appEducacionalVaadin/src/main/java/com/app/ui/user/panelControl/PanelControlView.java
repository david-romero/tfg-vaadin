...
*/
package com.app.ui.user.panelControl;
...
public class PanelControlView extends Panel implements View{
    ...
    private Component buildEditButton() {
        ...
        result.addClickListener(new ClickListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -6057990549390452918L;
...
//                                .getValue()));
    ...
    private void openNotificationsPopup(final ClickEvent event) {
        ...
        if ( !(getCurrentUser() instanceof Administrador) ){
        	switch (getCurrentUser().getClass().getSimpleName()) {
			case "Profesor":
				Profesor p = (Profesor) getCurrentUser();
				notifications.addAll(p.getNotificaciones());
				break;
			case "PadreMadreOTutor":
				PadreMadreOTutor p2 = (PadreMadreOTutor) getCurrentUser();
				notifications.addAll(p2.getNotificaciones());
				break;
        ...
        for (Notificacion notification : notifications) {
            ...
            java.text.SimpleDateFormat sp = new java.text.SimpleDateFormat("dd/MM/yyyy");
    ...
    public static final class NotificationsButton extends Button {
        ...
        public void updateNotificationsCount(
            ...
            setUnreadCount(notificacionService.getNotificacionesNoLeidas(currentPerson));
        }
