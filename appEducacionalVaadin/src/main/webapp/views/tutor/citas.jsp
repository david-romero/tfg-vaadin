...
<display:table requestURI="${requestURI}"  
	...
	<display:column class="col-lg-3" property="profesor" title="${apellidosHeader}" sortable="true" headerClass="sortable" >
...
<display:table requestURI="${requestURI}"  
	...
	<spring:message code="notificacion.content" var="fotoHeader" />
	<display:column class="col-lg-3" title="${fotoHeader}" sortable="false" property="contenido" >
	...
	<display:column style="text-align: center;" class="col-lg-2" title="¿Padre, Madre o Tutor?" sortable="false" >
		<jstl:choose>
			...
			<jstl:otherwise>
				<a title="Confirmar Cita" href="app/tutor/profesor/confirmarCita.do?cita=${row.id}"><i class="fa fa-times"></i></a>
			</jstl:otherwise>
		</jstl:choose>
	</display:column>
