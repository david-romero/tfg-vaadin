...
<jstl:if test="${tieneTutores}">

	<form:form cssStyle="" id="formulario" action="app/profesor/alumno/guardarCita.do" modelAttribute="cita"  >
		...
		<form:hidden path="emisor"/>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="input-group">
					...
					<div class="input-group-btn">
						<!--  <img style="width:30px;margin-top:-15px;" align="middle" id="datepickerImage" 
									src="images/icono_calendario.gif" onclick="cargarTimePicker();">-->
						<a style="height: 140%;margin-top: 0px;" class="btn btn-default" onclick="cargarTimePicker();">
							<i style="margin-top: 3px;" class="fa fa-calendar"></i>
						</a>
					</div>
				</div>
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<form:input cssClass="form-control" path="contenido" />
				<form:errors cssClass="error" path="contenido" />
			</div>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<form:label path="padreMadreOTutor">Seleccione el tutor:</form:label>
				<div class="input-group">
					<span class="input-group-addon" style="text-align: left;">
						<form:radiobuttons  itemLabel="nombre" delimiter="<br>" itemValue="id" items="${tutores}" path="padreMadreOTutor"/>
					</span>
				</div>
					<form:errors cssClass="error" path="padreMadreOTutor" />
			</div>
