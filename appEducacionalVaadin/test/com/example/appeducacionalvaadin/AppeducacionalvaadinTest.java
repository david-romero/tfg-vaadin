package com.example.appeducacionalvaadin;
 ...
 */
public class AppeducacionalvaadinTest extends TestBenchTestCase {
    @Rule
    ...
    private void openTestUrl() {
        getDriver().get("http://localhost:8080/appEducacionalVaadin");
    }
